...
int main (int argc, char* argv[]) {
    ...
    bool ok;
    // std::cout << GLOBAL::TRAIN_FILE_NAME<< std::endl;
    ...
    // std::cout << "Train size:" << labelTrain.size()<< std::endl;
    ...
    // std::cout<<"Test label size:" << labelTest.size()<<std::endl;
    std::cout << labelPred[0] << std::endl;
